"""
    ==================================================================================================
    MODIFIED PYTHON LEXER FOR USE IN REAKTORO
    THIS FILE NEEDS TO REPLACE THE ORIGINAL FILE IN
        ~/miniconda3/envs/reaktoro-jupyter-book/lib/python3.x/site-packages/pygments/lexers/python.py
    04.01.2022, Allan Leal
    ==================================================================================================
...
from pygments.lexer import Lexer, RegexLexer, include, inherit, bygroups, using, \
...
class PythonLexerBase(RegexLexer):
    """
...
class PythonLexer(PythonLexerBase):
    tokens = {
        'root': [ inherit ],
        'expr': [ inherit ],
        'expr-inside-fstring': [ inherit ],
        'expr-inside-fstring-inner': [ inherit ],
        'expr-keywords': [ inherit ],
        'keywords': [ inherit ],
        'builtins': [ inherit ],
        'magicfuncs': [ inherit ],
        'magicvars': [ inherit ],
        ...
        'import': [ inherit ],
        'fromimport': [ inherit ],
        'rfstringescape': [ inherit ],
        'fstringescape': [ inherit ],
        'stringescape': [ inherit ],
        'dqf': [ inherit ],
        'sqf': [ inherit ],
        'dqs': [ inherit ],
        'sqs': [ inherit ],
